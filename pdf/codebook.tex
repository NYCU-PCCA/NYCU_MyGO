...
\lstset{
  ...
  emph={chmin, chmax, abs2, acos2, cos, cosl, sin, sinl, acos, acosl, asin, asinl, sqrt, sqrtl, atan2, atan2l, fill, fill_n, iota, swap, copy_n, assign, push_back, max, min, SZ, ALL, RALL, __lg, eb, ef, pb, pf, ee},
  morekeywords={*,size_t,int64_t,ll,ld,pii,constexpr,tuple,vector,i64,u64,f64, complex, string, REP, pair},
  % if you want to add more keywords to the set
  morekeywords={[2]{MOD,MAXN,INF,MAXC,MAXM}},
...
\fancyhead[R]{NYCU\_MyGO!!!}
\fancyhead[C]{記得初始化 · 確認題目範圍    National Yang Ming Chiao Tung University}
\fancyhead[L]{\thepage}
