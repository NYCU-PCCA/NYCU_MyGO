...
\lstset{
  ...
  emph={chmin, chmax, abs2, acos2, fill, fill_n, iota, swap, copy_n, assign, push_back, max, min, SZ, ALL, RALL, __lg, __gcd},
  morekeywords={*,size_t,int64_t,ll,ld,pii,constexpr,tuple,vector,ull, complex, string, REP, pair},
