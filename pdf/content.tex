\newcommand{\isLinux}{false}
\newcommand{\hasPython}{true}
\newcommand{\hasJava}{true}
\newcommand{\hasKotlin}{false}
...
\IncludeCodeHash[]{Lazy SegTree}{lazy_segtree.cpp}
...
\IncludeCodeHash[]{Pr\"ufer $\to$ 樹}{prufer.cpp}
...
\IncludeCodeHash[]{$O(\sqrt{n})$ 數質數}{pi_count.cpp}
...
\IncludeCodeHash[]{SAIS}{sais-C++20.cpp}
\IncludeCodeHash[]{SAIS Tools}{sais-tools.cpp}
...
\IncludeCodeHash[]{Circle Intersect}{circle_intersect.cpp}
\IncludeCodeHash[]{Line Circle Intersect}{line_circle_intersect.cpp}
\IncludeCodeHash[]{Minimum Enclosing Circle}{minimum-enclosing-circle.cpp}
\IncludeCode[]{模擬退火}{simulate-annealing.cpp}


\SectionTitle{Misc}
\renewcommand\Prefix{../codes/misc/}
\IncludeCodeHash[]{Bit Hacks}{bit-hacks.hpp}
\IncludeCodeHash[]{PBDS Custom Policy}{pbds-policy.cpp}
...
\SectionTitle{MyGO!!!}
\includegraphics[width=0.3\textwidth]{mygo.png}
